...
export function redrawRouteForCurrentFloor(): void {
  ...
  if (startNode.floor === state.currentFloor) {
    const startIcon = L.divIcon({
      ...
      html: `<div style="background: ${UI_CONFIG.ROUTE_START_COLOR}; color: white; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 16px; font-family: 'JetBrains Mono', monospace; border: 3px solid white; box-shadow: 0 2px 8px rgba(0,0,0,0.3)">A</div>`,
      iconSize: [36, 36],
      iconAnchor: [18, 18],
    })
  ...
  if (endNode.floor === state.currentFloor) {
    const endIcon = L.divIcon({
      ...
      html: `<div style="background: ${UI_CONFIG.ROUTE_END_COLOR}; color: white; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 16px; font-family: 'JetBrains Mono', monospace; border: 3px solid white; box-shadow: 0 2px 8px rgba(0,0,0,0.3)">B</div>`,
      iconSize: [36, 36],
      iconAnchor: [18, 18],
    })
