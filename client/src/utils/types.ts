 ...
 *
 * Produced by: developer-editor placement, server `nodes.json`.
...
export interface PathResult {
   ...
   * inflated by traffic-zone multipliers and stairway penalties
   * (`MAP_CONFIG.STAIR_COST`).  A separate physical-distance measurement
