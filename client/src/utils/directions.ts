 ...
 *
 * Paths are simplified per floor before instructions are generated. Written
 * directions intentionally use a stricter turn threshold than the amber route,
 * avoiding calls for shallow bends caused by graph-node placement.
 */
