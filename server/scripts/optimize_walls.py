#!/usr/bin/env python3
"""
Wall Optimization Script

Merges collinear wall segments to reduce data size.
Reduces ~30,000 segments to ~1,000 by combining parallel adjacent lines.
"""
...
INPUT_PATH = os.path.join(SCRIPT_DIR, '../data/walls.json')
OUTPUT_PATH = os.path.join(SCRIPT_DIR, '../data/walls_optimized.json')
...
def main():
    print("=" * 60)
    print("Wall Optimization Script")
    print("=" * 60)
